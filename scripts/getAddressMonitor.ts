...
export async function run(provider: NetworkProvider, args: string[]) {
    ...
    const campaignFactory = provider.open(BuyCardContract.createFromAddress(address));
    console.log("campaignFactory==");
    const getOwnerAddress = await campaignFactory.getAddressUserMonitor();
    console.log("getMonitorAddress==",getOwnerAddress);
